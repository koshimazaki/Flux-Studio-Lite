...
- Public-file review found no tracked interview-question or agent-note file. The broken questions link and stale agent-oriented wording were removed. Old source-input CSS was consolidated into `upscale.css`; all hand-written source remains below 500 lines.
